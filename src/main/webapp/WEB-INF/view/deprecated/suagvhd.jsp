...
<form:form action = "?suagvhd" modelAttribute="da">
	...
	<form:input type="hidden" path="DATYEUCAU" value="${da.DATYEUCAU}" required="1"/>
	<form:input type="hidden" path="DAPCGVPB" value="${da.DAPCGVPB}" required="1"/>
	<form:input type="hidden" path="DIEMCUOICUNG" value="${da.SINHVIEN.MASV}" required="1"/>
	<form:input type="hidden" path="NHANXETGVHD" value="${da.SINHVIEN.MASV}" required="1"/>
	<form:input type="hidden" path="DIEMHUONGDAN" value="${da.SINHVIEN.MASV}" required="1"/>
	<form:input type="hidden" path="DETAI.IDDETAI" value="${da.SINHVIEN.MASV}" required="1"/>
